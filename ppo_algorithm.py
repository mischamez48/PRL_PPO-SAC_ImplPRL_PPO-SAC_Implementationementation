...
class ActorNetwork(nn.Module):
    def __init__(self, n_actions, input_dims, actor_alpha, n_epochs, gamma, fc1_dims=64, fc2_dims=64):
...
class CriticNetwork(nn.Module):
    def __init__(self, input_dims, critic_alpha, n_epochs, gamma, fc1_dims=64, fc2_dims=64):
